        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="./">
                    <img src="assets/uploads/atechs-logo.jpeg" alt="AtechsSolutions" style="height: 70px; margin-right: 12px;">
                    Atechs Events Management System Solution
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="javascript:void(0)" id="register_now">Register</a></li>
                        <?php else: ?>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="admin/logout.php">Logout</a></li>
                        <?php endif; ?>
